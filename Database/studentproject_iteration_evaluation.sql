...
CREATE TABLE `iteration_evaluation` (
  ...
  KEY `iterID_idx` (`iteration_id`),
  KEY `clid_idx` (`class_id`),
  KEY `teid_idx` (`team_id`),
  KEY `userd_idx` (`user_id`),
  KEY `iid_idx` (`iteration_id`),
  CONSTRAINT `clssId` FOREIGN KEY (`class_id`) REFERENCES `class_user` (`class_id`),
  CONSTRAINT `iid` FOREIGN KEY (`iteration_id`) REFERENCES `iteration` (`iteration_id`),
  CONSTRAINT `tdd` FOREIGN KEY (`team_id`) REFERENCES `class_user` (`team_id`),
  CONSTRAINT `uidd` FOREIGN KEY (`user_id`) REFERENCES `class_user` (`user_id`)
