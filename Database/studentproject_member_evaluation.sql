...
CREATE TABLE `member_evaluation` (
  ...
  KEY `evaaid_idx` (`evaluation_id`),
  KEY `crid_idx` (`criteria_id`),
  CONSTRAINT `crid` FOREIGN KEY (`criteria_id`) REFERENCES `criteria` (`criteria_id`),
  CONSTRAINT `evaaid` FOREIGN KEY (`evaluation_id`) REFERENCES `iteration_evaluation` (`evaluation_id`)
